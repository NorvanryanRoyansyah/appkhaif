...
class User_model extends CI_Model
{
    ...
    // datatables
    function json() {
        $this->datatables->select('id_users,full_name,email,jenis_kelamin,no_hp,nama_level,is_aktif');
    ...
    function get_all()
    {
        $this->db->select('id_users,full_name,email,jenis_kelamin,no_hp,nama_level,is_aktif');
       //add this line for join
