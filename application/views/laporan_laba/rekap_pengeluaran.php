...
<html>
    <head>
        <title>LAPORAN LABA BARANG</title>
    ...
    <body>
        ...
        <h4 class="text-center">LAPORAN REKAP PENGELUARAN</h4>
        ...
        <table class="word-table" style="margin-bottom: 10px">
            ...
            <?php $this->load->model('Tbl_pengeluaran_model');?>
            <?php
                    ...
                    for ($i = 1; $i <= 31; $i++) {
                        ...
                        $users = $this->Tbl_pengeluaran_model->get_pengeluaran($i, $bln, $thn);
                    ...
                    echo "<b>Total Pengeluaran Perbulan </b>: Rp ".separateThousands($total).""; // Menampilkan total jumlah di luar loop
            ?>
