    ...
    <div class="container">
      <div class="card mt-3">
        ...
        <div class="card-body">
            ...
            <tbody>
              ...
              foreach ($items as $items) : ?>
               ...
               <!-- <td><?php echo $items['id'] ?></td> -->
                  ...
                  <td>
                    <a href="<?php echo base_url() ?>index.php/List_produk/hapus_keranjang_jasa/<?php echo $items['rowid']; ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
              <?php endforeach; ?>
            </tbody>
          ...
          <form class="form-validate" action="<?php echo base_url() ?>index.php/List_produk/proses_order_jasa" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <!-- FORM -->
              <form class="form-validate" action="<?php echo base_url() . 'index.php/list_produk/tambahjasa'; ?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
    ...
    <?php endforeach; ?>
        ...
        <script>
          ...
          function changebutton(){
             //Removed additional space after level
